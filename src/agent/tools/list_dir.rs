...
impl Tool for ListDirTool {
    ...
    async fn definition(&self, _prompt: String) -> ToolDefinition {
        ToolDefinition {
            ...
            description: "List files and directories. Respects .gitignore. Shows type, size, entry count for subdirectories. Sorted: directories first, then alphabetical.".to_string(),
